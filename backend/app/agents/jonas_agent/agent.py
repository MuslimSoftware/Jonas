...
def before_model_callback(callback_context: InvocationContext, llm_request: LlmRequest):
    ...
    #     print(f"JonasAgent BEFORE Callback: Context IDs (accessed via _invocation_context.session) - User='{user_id}', Session='{session_id}'. State will not be modified here.")
